...
- [x] Process all tweets by using the botometer API: https://botometer.osome.iu.edu

- [ ] Interpret the results and find a suited threshold 

- [ ] Analyse the results: Frequency and distribution over time 

**Sentiment Analysis**

- [ ] Perform Sentiment Analysis with the tweets indenified as "bot-like"
